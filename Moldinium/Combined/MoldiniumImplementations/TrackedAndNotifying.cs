    ...
    where Exception : System.Exception
{
    ...
    bool BeforeGet(ref Value value, ref Mixin mixin);

    void AfterGet(ref Value value, Container container, ref Mixin mixin);
    void AfterSet(ref Mixin mixin);

    bool AfterErrorGet(Exception exception, Container container, ref Mixin mixin);
    bool AfterErrorSet(ref Mixin mixin);
}
